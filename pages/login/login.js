document.addEventListener('DOMContentLoaded', function () {
    ...
    var VideoController = {
        playlist: [
            '../../video/1.mp4',
            '../../video/Luxury_Restaurant_Entrance_VIP_Arrival.mp4',
            '../../video/Chef_Plates_Gourmet_Levantine_Meal.mp4',
            '../../video/Craft_Cocktail_Pouring_Video_Generated.mp4'
        ],
        currentIndex: 0,
    ...
    function validateConfirmPassword(value) {
        ...
        if (value !== els.password.value) return 'Passwords do not match';
        return null;
    }
    ...
    if (els.form) {
        els.form.addEventListener('submit', function (e) {
            ...
            setTimeout(function () {
                ...
                if (state.mode === 'login') {
                    els.successTitle.textContent = 'Welcome Back';
                    els.successSubtitle.textContent = 'Preparing your private lounge...';
                } else {
                    els.successTitle.textContent = 'Welcome to L\'ELITE';
                    els.successSubtitle.textContent = 'Your exclusive membership awaits...';
                }
                els.successOverlay.classList.add('visible');
            }, 1500);
        });
    }
    ...
    socialBtns.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            setTimeout(function () {
                showToast('Redirecting to ' + provider.charAt(0).toUpperCase() + provider.slice(1) + '...');
            }, 500);
